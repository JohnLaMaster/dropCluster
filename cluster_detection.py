...
__all__ = ['citation', 'min_clusters', 'max_clusters', 'median_clusters', 'majority_clusters', 'all_methods', 'CH',
           'SC', 'DB', 'BIC', 'ELBOW', 'optimal_number_of_clusters', 'calculate_wcss', 'GAP_STATISTICS']


citation = OrderedDict({'Title': 'EvoCluster: An Open-Source Nature-Inspired Optimization Clustering Framework in Python',
                        'Authors': 'Raneem Qaddoura, Hossam Faris, Ibrahim Aljarah, Pedro A. Castillo',
                        'Year': '2020',
                        'Journal': 'International Conference on the Applications of Evolutionary Computation',
                        'Institution': 'Information Technology, Philadelphia University; King Abdullah II School for '
                                       'Information TechnologyThe University of Jordan; ETSIIT-CITIC, University of Granada',
                        'URL': 'https://link.springer.com/chapter/10.1007/978-3-030-43722-0_2',
                        'Notes': '',
                        'Source Code': 'Adopted from: https://github.com/RaneemQaddoura/EvoCluster'})
...
### gap statistics
def GAP_STATISTICS(data, K=range(1,11)):
    gaps, s_k, K = gap_statistic(data, refs=None, B=10, K=K, N_init = 10) 
